...
// Create creates a new set of five shares
func Create(raw string) (string, error) {
	...
	if minimum > shares {
		return "", errors.New("cannot require more shares then existing")
	}
	...
	// ...and return!
	finresult := "SHARE1:" + result[0] + "SHARE2:" + result[1] + "SHARE3:" + result[2] +
		"SHARE4:" + result[3] + "SHARE5:" + result[4]
...
// Combine combines five shares
func Combine(share1 string, share2 string, share3 string, share4 string, share5 string) (string, error) {
	// Recreate the original object of x, y points, based upon number of shares
	// and size of each share (number of parts in the secret).
	shares := []string{share1, share2, share3, share4, share5}
